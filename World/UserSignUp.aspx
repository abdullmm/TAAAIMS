<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="UserSignUp.aspx.cs" Inherits="UserSignUp" %>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <h2 class="text-center" id="title"><img src="/images/logocrop.png" alt="logocopy" runat="server" id="logo" class="teamLogo"/></h2>
                            <div class="px-2 ">
                                <div id="form" class="justify-content-center" align="center">
                                    <fieldset>              
